...
if(Java.available){
    ...
    Java.perform( function() {
        ...
        var packagename = context.getPackageName();
	      send({packageName:packagename, method:"loadUrl", Url: url, Header:"",userAgent:this.getSettings().getUserAgentString()});
		  ...
		  send({ method: "loadUrlHeader", Url: url,Header:header,userAgent:this.getSettings().getUserAgentString()});
		   }
		   
		WebView.postUrl.overload('java.lang.String', '[B').implementation=function(url,data){
			console.log("WebView.postUrl :" + url);
		    send({ method: "postUrl", Header:"",userAgent:this.getSettings().getUserAgentString()});
	...
	WebView.loadDataWithBaseURL.overload('java.lang.String','java.lang.String','java.lang.String','java.lang.String','java.lang.String').implementation = function(url,p2,p3,p4,p5){
          this.loadDataWithBaseURL(p1,p2,p3,p4,p5);
		   send({ method: "loadDataWithBaseURL", Header:"", Url: url,userAgent:this.getSettings().getUserAgentString()});
		   };
        ...
        var context = ActivityThread.currentApplication().getApplicationContext();
        var packagename = context.getPackageName();
   	     send({ packageName:packagename, method: "onLoadResource", Header:"", Url: url,userAgent:p0.getSettings().getUserAgentString()});
